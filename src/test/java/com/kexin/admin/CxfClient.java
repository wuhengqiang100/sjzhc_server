...
//        try {
//            // 接口地址
//            String address = "http://127.0.0.1:8088/kexin/webservice/user?wsdl";
//            // 代理工厂
...
//            Map<String, UserWeb> userMaps= us.getAllUserData();
//            System.out.println("返回结果:" + userMaps);
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//    }
...
//        Client client = dcf.createClient("http://127.0.0.1:8088/kexin/webservice/user?wsdl");
//        // 需要密码的情况需要加上用户名和密码
