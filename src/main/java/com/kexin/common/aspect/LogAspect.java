package com.kexin.common.aspect;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.kexin.common.annotation.SysLog)")
    public void webLog(){}
...
//        str = str.length() > 2000 ? str.substring(2000) : str;
        ...
        SysLog mylog = method.getAnnotation(com.kexin.common.annotation.SysLog.class);
        if(mylog != null){
            //注解上的描述
