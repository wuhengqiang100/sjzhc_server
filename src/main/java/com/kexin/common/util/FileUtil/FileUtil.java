...
//                String filePath = ftp.getLocalpath()+ file.getOriginalFilename();
                ...
                String filePath = ftp.getLocalpath()+rfilename+'\\'+ rfilename+suffix;
    ...
    public static String getFirstSuffix(MultipartFile file){
        String originalFilename = file.getOriginalFilename();//timg (1).jpg
        //获取最后一个.的位置
        int firstIndexOf = originalFilename.indexOf(".");
        //获取文件的后缀名 .jpg
        String firstString = originalFilename.substring(firstIndexOf);
        return firstString;
    }
